...
describe('Parser', () => {
  ...
  const inputFarm = [
    {
      ...
      pid: 0,
      lp_symbol: 'RYIP',
      lp_mainnet_address: '0x0A9Ed1ad9D99bc01b163E9038556fE60ec2151ec',
      token: {
        _id: '5ffd7e79361bff0009cc8189',
        decimals: 18,
        name: 'UNITY',
        symbol: 'UNITY',
        mainnet_address: '0x0A9Ed1ad9D99bc01b163E9038556fE60ec2151ec',
  ...
  it('Pool - Return the correct value', () => {
    const outPut = [
      {
        unityId: '5ffd7e80361bff0009cc8198',
        tokenName: undefined,
    ...
    const outPut = [
      {
        pid: 0,
        lpSymbol: 'RYIP',
        lpAddresses: '0x0A9Ed1ad9D99bc01b163E9038556fE60ec2151ec',
        tokenSymbol: 'UNITY',
        tokenAddresses: '0x0A9Ed1ad9D99bc01b163E9038556fE60ec2151ec',

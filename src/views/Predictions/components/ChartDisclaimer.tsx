...
import { ModalContainer, ModalBody, Text, Button, InjectedModalProps, LinkExternal, Flex } from '@unityswap/uikit'
    ...
    <ModalContainer title={t('Welcome!')} minWidth="320px">
      <ModalBody p="24px" maxWidth="400px">
        ...
        <Flex justifyContent="center" alignItems="center">
          <LinkExternal
            href="https://docs.unity-swap.finance/products/prediction/prediction-faq#what-are-you-using-for-your-price-feed"
            external
          >
            {t('Learn More')}
          </LinkExternal>

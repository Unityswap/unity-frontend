...
import { useMatchBreakpoints, useModal } from '@unityswap/uikit'
...
const Predictions = () => {
  ...
  const [hasAcceptedRisk, setHasAcceptedRisk] = usePersistState(false, 'unity_predictions_accepted_risk')
  const [hasAcceptedChart, setHasAcceptedChart] = usePersistState(false, 'unity_predictions_chart')

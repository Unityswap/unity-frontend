...
import { Heading, Card, CardBody, CardFooter, Text, UnityRoundIcon, Flex, Skeleton } from '@unityswap/uikit'
...
const TotalPrizesCard = () => {
  ...
  const lotteryPrizeAmountBusd = new BigNumber(lotteryPrizeAmount).multipliedBy(usePriceRyipBusd()).toNumber()
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading scale="lg">{lotteryPrizeWithCommaSeparators} RYIP</Heading>

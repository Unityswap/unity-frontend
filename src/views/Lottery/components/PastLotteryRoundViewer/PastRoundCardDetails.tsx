...
import { Heading, CardBody, CardFooter, UnityRoundIcon, TicketRound } from '@unityswap/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading valueToDisplay={t(`${poolSize.toLocaleString()} RYIP`)} Icon={UnityRoundIcon}>
              {t('Total prizes')}
            </LotteryCardHeading>
          </CardHeading>
        </CardBody>

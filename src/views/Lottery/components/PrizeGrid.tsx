...
import { Heading, Text } from '@unityswap/uikit'
...
const PrizeGrid: React.FC<PrizeGridProps> = ({
  ...
  const ryipBusdPrice = usePriceRyipBusd()

  const getRyipBusdValue = (amount: number) => {
    return new BigNumber(amount).multipliedBy(ryipBusdPrice).toNumber()
  }
    ...
    <Grid pastDraw={pastDraw}>
      ...
      <GridItem>
        <RightAlignedHeading scale="md">
          ...
          {!pastDraw && !ryipBusdPrice.eq(0) && <CardBusdValue value={getRyipBusdValue(fourMatchesAmount)} />}
        </RightAlignedHeading>
      </GridItem>
      {/* 3 matches row */}
      <GridItem>
      ...
      <GridItem>
        <RightAlignedText>
          ...
          {!pastDraw && !ryipBusdPrice.eq(0) && <CardBusdValue value={getRyipBusdValue(threeMatchesAmount)} />}
        </RightAlignedText>
      </GridItem>
      {/* 2 matches row */}
      <GridItem>
      ...
      <GridItem>
        <RightAlignedText>
          ...
          {!pastDraw && !ryipBusdPrice.eq(0) && <CardBusdValue value={getRyipBusdValue(twoMatchesAmount)} />}
        </RightAlignedText>
      </GridItem>
      {/* Burn row */}

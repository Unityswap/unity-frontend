...
import { Stepper, Step, StepStatus, Card, CardBody, Heading, Text, Button, Link, OpenNewIcon } from '@unityswap/uikit'
    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              You’ll need an active UnitySwap Profile to take part in an IFO!
            </Text>
            {isStepValid ? (
      ...
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              Get RYIP-BNB LP Tokens
            </Heading>
            <Text color="textSubtle" small>
              Stake RYIP and BNB in the liquidity pool to get LP tokens. <br />
              You’ll spend them to buy IFO sale tokens.
            </Text>
            <Button
              as={Link}
              external
              href={`${BASE_ADD_LIQUIDITY_URL}/BNB/0x0A9Ed1ad9D99bc01b163E9038556fE60ec2151ec`}
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent RYIP-BNB LP

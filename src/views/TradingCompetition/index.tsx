...
import { Flex, Box, Image } from '@unityswap/uikit'
...
import StormPanther from './pngs/storm.png'
...
const BottomPantherWrapper = styled(Box)`
  display: none;
...
const TradingCompetition = () => {
  ...
  const { hasUserClaimed, userRyipRewards, userPointReward, canClaimNFT } = userTradingInformation

  const userCanClaimPrizes =
    currentPhase.state === CLAIM &&
    !hasUserClaimed &&
    (userRyipRewards !== '0' || userPointReward !== '0' || canClaimNFT)
    ...
    <CompetitionPage>
      ...
      <Section backgroundStyle={DARKBG} svgFill={DARKFILL} index={4} intersectionPosition="top">
        <Flex alignItems="center">
          ...
          <BottomPantherWrapper>
            <Image src={StormPanther} width={147} height={200} />
          </BottomPantherWrapper>
        </Flex>
      </Section>
    </CompetitionPage>

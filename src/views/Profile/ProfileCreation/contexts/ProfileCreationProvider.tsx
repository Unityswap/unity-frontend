...
import { getPantherFactoryContract } from 'utils/contractHelpers'
...
const initialState: State = {
  ...
  userName: '',
  minimumRyipRequired: new BigNumber(totalCost).multipliedBy(DEFAULT_TOKEN_DECIMAL),
...
const ProfileCreationProvider: React.FC = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const pantherFactoryContract = getPantherFactoryContract()
      const canMint = await pantherFactoryContract.methods.canMint(account).call()

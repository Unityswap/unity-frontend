...
import { Button, Flex, Heading, useModal, Won } from '@unityswap/uikit'
import { useProfile } from 'state/hooks'
import { useTranslation } from 'contexts/Localization'
import ClaimNftAndRyipModal, { useCanClaim } from './ClaimGiftModal'
...
const ProfileHeader = () => {
  ...
  const [onPresentClaimGiftModal] = useModal(<ClaimNftAndRyipModal onSuccess={checkClaimStatus} />)

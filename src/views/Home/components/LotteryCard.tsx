...
import { Heading, Card, CardBody, Button, useModal } from '@unityswap/uikit'
...
import RyipWinnings from './RyipWinnings'
...
const LotteryCard = () => {
  ...
  const [onPresentBuy] = useModal(<BuyTicketModal max={ryipBalance} />)
  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        ...
        <CardImage src="/images/ticket.svg" alt="ryip logo" width={64} height={64} />
        <Block>
          <Label>{t('RYIP to Collect')}:</Label>
          <RyipWinnings claimAmount={claimAmount} />
        </Block>
        <Block>

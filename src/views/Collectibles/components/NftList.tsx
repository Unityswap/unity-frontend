...
import PantherSpecialCard from './NftCard/PantherSpecialCard'
import EasterNftCard from './NftCard/EasterNftCard'

/**
 * A map of pantherIds to special campaigns (NFT distribution)
 * Each NftCard is responsible for checking it's own claim status
 *
 */
const nftComponents = {
  hiccup: PantherSpecialCard,
  bullish: PantherSpecialCard,
  'easter-storm': EasterNftCard,
  'easter-flipper': EasterNftCard,
  'easter-ryipr': EasterNftCard,
}

...
import { CardHeader, Heading, Text, Flex, Image } from '@unityswap/uikit'
...
const StyledCardHeader: React.FC<{
  ...
  const isRyipPool = earningTokenSymbol === 'RYIP' && stakingTokenSymbol === 'RYIP'

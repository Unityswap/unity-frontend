...
import { CardBody, Flex, Text, CardRibbon } from '@unityswap/uikit'
...
const PoolCard: React.FC<{ pool: Pool; account: string }> = ({ pool, account }) => {
  const { unityId, stakingToken, earningToken, isFinished, userData } = pool
  ...
  return (
    <StyledCard
      isFinished={isFinished && unityId !== 0}

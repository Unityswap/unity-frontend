...
import { Flex, TooltipText, IconButton, useModal, CalculateIcon, Skeleton, useTooltip } from '@unityswap/uikit'
...
const AprRow: React.FC<AprRowProps> = ({
  ...
  const tooltipContent = isAutoVault
    ? t('APY includes compounding, APR doesn’t. This pool’s RYIP is compounded automatically, so we show APY.')
